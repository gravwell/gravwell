...
var testSetList = []testSet{
	...
	testSet{name: `Syslog`, data: fmt.Sprintf(`xyz %s %02s 12:44:18`, monthAbrev(), todayString()), ts: time.Date(year(), month(), today(), 12, 44, 18, 0, time.UTC)},
	...
	testSet{name: `GravwellTimePicker`, data: `07/01/2025 11:25:36 AM`, ts: time.Date(2025, time.July, 1, 11, 25, 36, 0, time.UTC)},
}
