...
echo "running staticcheck"
	...
	GOOS=windows GOARCH=amd64 staticcheck ./generators/windowsEventGenerator/...
	GOOS=windows GOARCH=amd64 staticcheck ./winevent/...
	GOOS=windows GOARCH=amd64 staticcheck ./ingesters/winevents/...
	staticcheck ./ingest
	...
	GOOS=linux staticcheck ./ipexist/...
	...
	CGO_ENABLED=1 staticcheck ./ingesters/networkLog/...
	...
	GOOS=linux staticcheck ./ingesters/Shodan/...
...
echo "running govulncheck on everything"
        govulncheck -test ./netflow/...
        govulncheck -test ./manager/...
        GOOS=linux govulncheck -test ./ipexist/...
        ...
        GOOS=linux govulncheck -test ./ingesters/Shodan
        ...
        GOOS=linux govulncheck -test ./ingesters/canbus
        ...
        govulncheck -test ./ingesters/hosted/...
...
echo "Running build tests"
        ...
        GOOS=linux go build -o /dev/null ./ipexist/textinput
        go build -o /dev/null ./kitctl
        GOOS=windows GOARCH=amd64 go build -o /dev/null ./ingesters/fileFollow
        GOOS=windows GOARCH=amd64 go build -o /dev/null ./ingesters/winevents
        GOOS=windows GOARCH=amd64 go build -o /dev/null ./generators/windowsEventGenerator
        ...
        GOOS=linux go build -o /dev/null ./ingesters/canbus
        ...
        go build -o /dev/null ./ingesters/hosted/runner
