//go:build !386 && !arm && !mips && !mipsle && !s390x && !windows
// +build !386,!arm,!mips,!mipsle,!s390x,!windows

//lint:file-ignore SA1019 this is all to support legacy plugins, can't change imports
...
func init() {
	...
	decs["DecodingLayerArray"] = reflect.TypeOf((*gopacket.DecodingLayerArray)(nil)).Elem()
	decs["DecodingLayerContainer"] = reflect.TypeOf((*gopacket.DecodingLayerContainer)(nil)).Elem()
	decs["DecodingLayerFunc"] = reflect.TypeOf((*gopacket.DecodingLayerFunc)(nil)).Elem()
	decs["DecodingLayerMap"] = reflect.TypeOf((*gopacket.DecodingLayerMap)(nil)).Elem()
	...
	decs["DecodingLayerSparse"] = reflect.TypeOf((*gopacket.DecodingLayerSparse)(nil)).Elem()
	...
	decs["LayersDecoder"] = gopacket.LayersDecoder
