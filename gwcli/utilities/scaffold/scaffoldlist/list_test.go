	...
	tests := []struct {
		...
		{"csv with exclude default",
			...
			"BackfillEnabled,Disabled,Schedule,CreatedAt,DeletedAt,Description,ItemID,Kit,Labels,Name,Owner.Admin,Owner.CreatedAt,Owner.DefaultSearchGroups,Owner.DeletedAt,Owner.Email,Owner.Groups,Owner.ID,Owner.LastLogin,Owner.Locked,Owner.MFA.RecoveryCodes.Codes,Owner.MFA.RecoveryCodes.Enabled,Owner.MFA.RecoveryCodes.Generated,Owner.MFA.RecoveryCodes.Remaining,Owner.MFA.TOTP.Enabled,Owner.MFA.TOTP.Seed,Owner.MFA.TOTP.URL,Owner.Name,Owner.SearchPriority,Owner.SSOUser,Owner.UpdatedAt,Owner.Username,OwnerID,ParentID,Readers.GIDs,Readers.Global,Type,UpdatedAt,Version,Writers.GIDs,Writers.Global,Flow\n" +
				"false,false,,1970-01-01 00:00:05 +0000 UTC,null,,0,,[],Name_0,false,0001-01-01 00:00:00 +0000 UTC,[],0001-01-01 00:00:00 +0000 UTC,,[],0,0001-01-01 00:00:00 +0000 UTC,false,[],false,0001-01-01 00:00:00 +0000 UTC,0,false,,,,0,false,0001-01-01 00:00:00 +0000 UTC,,0,,[1 100],true,,0001-01-01 00:00:00 +0000 UTC,0,[],false,Flow_0\n" +
				"false,false,,1970-01-01 00:00:05 +0000 UTC,null,,1,,[],Name_1,false,0001-01-01 00:00:00 +0000 UTC,[],0001-01-01 00:00:00 +0000 UTC,,[],0,0001-01-01 00:00:00 +0000 UTC,false,[],false,0001-01-01 00:00:00 +0000 UTC,0,false,,,,0,false,0001-01-01 00:00:00 +0000 UTC,,0,,[1 100],true,,0001-01-01 00:00:00 +0000 UTC,0,[],false,Flow_1\n" +
				"false,false,,1970-01-01 00:00:05 +0000 UTC,null,,2,,[],Name_2,false,0001-01-01 00:00:00 +0000 UTC,[],0001-01-01 00:00:00 +0000 UTC,,[],0,0001-01-01 00:00:00 +0000 UTC,false,[],false,0001-01-01 00:00:00 +0000 UTC,0,false,,,,0,false,0001-01-01 00:00:00 +0000 UTC,,0,,[1 100],true,,0001-01-01 00:00:00 +0000 UTC,0,[],false,Flow_2\n" +
				"false,false,,1970-01-01 00:00:05 +0000 UTC,null,,3,,[],Name_3,false,0001-01-01 00:00:00 +0000 UTC,[],0001-01-01 00:00:00 +0000 UTC,,[],0,0001-01-01 00:00:00 +0000 UTC,false,[],false,0001-01-01 00:00:00 +0000 UTC,0,false,,,,0,false,0001-01-01 00:00:00 +0000 UTC,,0,,[1 100],true,,0001-01-01 00:00:00 +0000 UTC,0,[],false,Flow_3\n" +
				"false,false,,1970-01-01 00:00:05 +0000 UTC,null,,4,,[],Name_4,false,0001-01-01 00:00:00 +0000 UTC,[],0001-01-01 00:00:00 +0000 UTC,,[],0,0001-01-01 00:00:00 +0000 UTC,false,[],false,0001-01-01 00:00:00 +0000 UTC,0,false,,,,0,false,0001-01-01 00:00:00 +0000 UTC,,0,,[1 100],true,,0001-01-01 00:00:00 +0000 UTC,0,[],false,Flow_4",
		},
...
func TestHelpGeneration(t *testing.T) {
	...
	t.Run("omitting flags removes them from help text", func(t *testing.T) {
		tests := []struct {
			name string
			omit scaffold.QOOmit
		}{
			{"no omissions includes all", scaffold.QOOmit{}},
			{"omit --all", scaffold.QOOmit{AllData: true}},
			{"omit --limit", scaffold.QOOmit{Limit: true}},
			{"omit --all and --include-deleted", scaffold.QOOmit{AllData: true, IncludeDeleted: true}},
			{"omit everything", scaffold.QOOmit{Everything: true}},
		}
		var sbOut, sbErr strings.Builder
