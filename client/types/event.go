...
func (d EventDispatcherInfo) MarshalJSON() ([]byte, error) {
	type dummyEventDispatcherInfo EventDispatcherInfo
	d.Labels = nonNilSlice(d.Labels)
	return json.Marshal(dummyEventDispatcherInfo(d))
}
