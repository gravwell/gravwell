...
//go:embed sflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000.bin
var Sflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000Bytes []byte

var Sflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000Decoded = &datagram.Datagram{
	Version:        5,
	IPVersion:      1,
	...
	Samples: []datagram.Sample{
		...
		&datagram.CounterSampleExpanded{
			...
			Records: []datagram.Record{
				...
				&datagram.HostDescr{RecordHeader: datagram.SampleHeader{Format: 2000, Length: 52}, HostName: datagram.XDRString{XDRVariableLengthOpaque: datagram.XDRVariableLengthOpaque{116, 104, 105, 110, 107, 112, 97, 100, 80, 49, 52, 115}}, UUID: datagram.SFlowUUID{101, 113, 225, 155, 101, 113, 81, 155, 165, 113, 225, 155, 101, 113, 225, 155}, MachineType: 3, OSName: 2, OSRelease: datagram.XDRString{XDRVariableLengthOpaque: datagram.XDRVariableLengthOpaque{54, 46, 49, 56, 46, 48, 0, 0}}},
			},
		},
	},
}

func TestSflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000(t *testing.T) {
	d := decoder.NewDatagramDecoder(bytes.NewReader(Sflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000Bytes))
	s, err := d.Decode()
	if err != nil {
		t.Fatal(err)
	}

	if !reflect.DeepEqual(s, Sflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000Decoded) {
		t.Fatalf("Decoded datagram does not match expected value.\nExpected: %+v\nGot: %+v\n", Sflow_sample_3_record_1_sample_4_record_2100_2001_2010_2009_2008_2007_2005_2004_2003_2006_2000Decoded, s)
	}
}
