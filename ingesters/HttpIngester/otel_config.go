...
func (o *otelListener) validate(name string) (string, error) {
	if len(o.URL) == 0 {
...
func (o *otelListener) tags() ([]string, error) {
	if len(o.Tag_Name) == 0 {
...
func includeOtelListeners(hnd *handler, igst *ingest.IngestMuxer, cfg *cfgType) (err error) {
